...
(function () {
  ...
  function vorbisCommentBlock(opts, isLast) {
    ...
    add('ALBUMARTIST', opts.albumArtist);
    add('GENRE', opts.genre);
    if (opts.trackNum) add('TRACKNUMBER', String(opts.trackNum));
    if (opts.trackTotal) add('TRACKTOTAL', String(opts.trackTotal));
    if (opts.discNum) add('DISCNUMBER', String(opts.discNum));
