...
(function () {
  ...
  function buildID3v2(opts) {
    ...
    if (opts.albumArtist) frames.push(textFrame('TPE2', opts.albumArtist));
    if (opts.year)   frames.push(textFrame('TDRC', String(opts.year)));
    if (opts.genre)  frames.push(textFrame('TCON', opts.genre));
    if (opts.trackNum) frames.push(textFrame('TRCK', opts.trackTotal ? `${opts.trackNum}/${opts.trackTotal}` : String(opts.trackNum)));
    if (opts.discNum)  frames.push(textFrame('TPOS', String(opts.discNum)));
