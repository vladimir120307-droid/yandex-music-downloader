...
**В десктопе:**
1. Открой программу
2. Нажми кнопку **«Получить»** рядом с полем «Я.Музыка токен»
3. **Залогинься** в Яндекс (если ещё нет), нажми «Разрешить доступ»
4. Тебя перебросит на адрес `music.yandex.ru/#access_token=ВОТ_ЭТУ_ДЛИННУЮ_СТРОКУ_КОПИРУЙ&token_type=...`
5. Скопируй значение `access_token` (между `=` и `&`), вставь в поле, нажми **«Сохранить»**
