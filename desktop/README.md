...
3. Тебя перебросит на адрес вида `music.yandex.ru/#access_token=ВОТ_ЭТУ_ДЛИННУЮ_СТРОКУ_КОПИРУЙ&token_type=...`
4. Скопируй значение `access_token` (между `=` и `&`), вставь в поле «Я.Музыка токен», нажми **«Сохранить»**
