...
Для авторизованных сервисов (Я.Музыка Premium, YouTube Premium, приватные плейлисты) выбери браузер в дропдауне «Cookies». yt-dlp прочитает куки прямо из его хранилища — логин делать не нужно.
